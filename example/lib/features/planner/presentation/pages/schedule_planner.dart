...
import 'package:edgar_planner_calendar_flutter/features/planner/presentation/widgets/scheduleview/schedule_view_event_tile.dart';
...
class _SchedulePlannerState extends State<SchedulePlanner<EventData>> {
  ...
  Widget build(BuildContext context) => SlScheduleView<EventData>(
        ...
        onWillAccept: (CalendarEvent<EventData>? event, DateTime dateTime) =>
            widget.onWillAccept(event, dateTime),
