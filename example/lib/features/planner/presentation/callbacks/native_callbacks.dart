...
class NativeCallBack {
  ...
  Future<bool> dateChanged(DateTime startTime, DateTime endTime) async {
  ...
  Future<bool> viewChanged(CalendarViewType calendarViewType) async {
    final Map<String, dynamic> data = <String, dynamic>{
  ...
  Future<bool> visibleDateChnged(DateTime dateTime) async {
  ...
  Future<bool> showEvent(DateTime dateTime,
  ...
  Future<bool> showdNonTeaching(CalendarEvent<EventData> event,
  ...
  Future<bool> fetchData(Term term) async {
    logPrety('Fetching data between ${term.startDate} and ${term.endDate}');
  ...
  Future<bool> fetchNotes(DateTime startDate, DateTime endDate) async {
    logPrety('Fetching Notes between $startDate and $endDate');
    final Map<String, String> data = <String, String>{
      'startDate': startDate.toString().substring(0, 10),
      'endDate': endDate.toString().substring(0, 10)
    };
    logPrety(data);
    await sendToNativeApp(SendMethods.fetchNotes, data);
    return true;
  }

  ///ask native app to fetch more data between speceffic date

  Future<bool> fetchDataDatesWise(DateTime startDate, DateTime endDate) async {
    logPrety('Fetching data for the $startDate $endDate');
    final Map<String, String> data = <String, String>{
      'startDate': startDate.toString().substring(0, 10),
      'endDate': endDate.toString().substring(0, 10)
    };
  ...
  Future<bool> addNote(DateTime dateTime, CalendarViewType viewType) async {
    final Map<String, dynamic> data = <String, dynamic>{
      'viewType': viewType.toString(),
  ...
  Future<bool> showNote(Note note, CalendarViewType viewType) async {
