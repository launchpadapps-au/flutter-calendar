...
class Preview {
  ...
  static Future<void> exportWeekView(DateTime startDate, DateTime endDate,
    ...
    final Size size = Size(
        ...
        bw +
            borderWidth +
            getTimelineHeight(timelines, ch, bw) +
            borderWidth +
            56);
                            ...
                            child: Center(
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Text(
                                    'From ${DateFormat('d MMMM').format(first)}To ${DateFormat('d MMMM y').format(last)}/ All Subjects/ Include Weekends',
  ...
  ///export week view
  static Future<void> exportMonthView(DateTime startDate, DateTime endDate,
      List<Period> timelines, List<PlannerEvent> event, BuildContext context,
      {bool saveImage = true}) async {
    final double ch = 110 * scaleFactor,
        bw = 35 * scaleFactor,
