...
///page snapping  physics
class PageSnapPhysics extends ScrollPhysics {
  ///initialize physics
  const PageSnapPhysics({required this.itemDimension, ScrollPhysics? parent})
      : super(parent: parent);
      ///dimension of the
  final double itemDimension;

  @override
  PageSnapPhysics applyTo(ScrollPhysics? ancestor) => PageSnapPhysics(
