...
class LinkedIndexedScrollControllerGroup {
  ...
  final _allControllers = <_LinkedIndexedScrollController>[];
  ...
  IndexedScrollController addAndGet() {
    ...
    final controller = _LinkedIndexedScrollController(this,
...
/// This class provides change notification for [LinkedIndexedScrollControllerGroup]'s
/// scroll offset.
///
